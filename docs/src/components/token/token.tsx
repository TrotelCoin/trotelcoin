    ...
    <section className="token" ref={ref}>
      ...
      <div className="partners">
        ...
        <div className="platforms">
          ...
          >
            <div className="rectangle-partners" id="rectangle-pancakeswap">
              <img
                ...
                alt="PancakeSwap"
              ></img>
              <p className="partners-label" id="pancakeswap-label">
                PancakeSwap
              </p>
            </div>
          </a>
          ...
          >
            <div className="rectangle-partners" id="rectangle-coinmarketcap">
              <img
                ...
                alt="CoinMarketCap"
              ></img>
              <p className="partners-label" id="coinmarketcap-label">
                CoinMarketCap
              </p>
            </div>
          </a>
          <a
            target="_blank"
            href="https://flooz.xyz/trade/0xf04ab1a43cBA1474160B7B8409387853D7Be02d5?network=bsc"
          >
            <div className="rectangle-partners" id="rectangle-flooz">
              <img
                className="platforms-image"
                id="flooz"
                src="./assets/flooz.png"
                alt="Flooz"
              ></img>
              <p className="partners-label" id="flooz-label">
                Flooz
              </p>
            </div>
          </a>
          ...
          >
            <div className="rectangle-partners" id="rectangle-bscchain">
              <img
                className="platforms-image"
                id="bscchain"
                src="./assets/binancesmartchain.png"
                alt="BSC Chain"
              ></img>
              <p className="partners-label" id="bscchain-label">
                BNB Chain
              </p>
            </div>
          </a>
